...
dkube_preprocessing_op      = components.load_component_from_url("https://raw.githubusercontent.com/hemanthravi/dkube-examples/sklearn/kubeflow/pipeline/preprocess.yaml")
dkube_training_op           = components.load_component_from_url("https://raw.githubusercontent.com/hemanthravi/dkube-examples/sklearn/kubeflow/pipeline/training.yaml")
dkube_serving_op            = components.load_component_from_url("https://raw.githubusercontent.com/hemanthravi/dkube-examples/sklearn/kubeflow/pipeline/serving.yaml")
